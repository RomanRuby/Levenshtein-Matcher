...
public class ViewDisplay {
    ...
    public void inputMode() {
        ...
        try {
            ...
            LOGGER.info("info Message Logged", new InputMismatchException(ex.toString()));
            input = 0;
        }
        switch (input) {
            case 1: {
    ...
    private Scanner fixScannerThread() {
        ...
        try {
            ...
            LOGGER.info("info Message Logged", new InterruptedException());
            System.out.println("");
        }
        return null;
    }
    ...
    private void filesSet() {
        ...
        String patternsFile = new Scanner(System.in).nextLine();
